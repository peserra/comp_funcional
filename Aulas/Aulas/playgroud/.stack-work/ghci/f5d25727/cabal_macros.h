...
/* package playgroud-0.1.0.0 */
#ifndef VERSION_playgroud
#define VERSION_playgroud "0.1.0.0"
#endif /* VERSION_playgroud */
#ifndef MIN_VERSION_playgroud
#define MIN_VERSION_playgroud(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_playgroud */
...
#define CURRENT_COMPONENT_ID "playgroud-0.1.0.0-J9qUNXxqbDC5ZblRxUTuI2-playgroud"
