...
/* package proj-exemplo-0.1.0.0 */
#ifndef VERSION_proj_exemplo
#define VERSION_proj_exemplo "0.1.0.0"
#endif /* VERSION_proj_exemplo */
#ifndef MIN_VERSION_proj_exemplo
#define MIN_VERSION_proj_exemplo(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_proj_exemplo */
...
#define CURRENT_COMPONENT_ID "proj-exemplo-0.1.0.0-CqQpv12vrPyIycP5XrRRam-proj-exemplo"
